...
def register_product_window():
    ...
    date_entry = DateEntry(add_window, date_pattern="mm-dd-yyyy", width=12, background='darkblue', foreground='white', borderwidth=2, font=("Hanuman Regular", 16))
...
def add_supply_window():
    ...
    add_supply_window.geometry("600x500")
    ...
    product_price_label = Label(add_supply_window, text="Product Price:", bg="#FFE1C6", font=("Hanuman Regular", 16))
    product_price_label.place(x=50, y=180)

    product_price_entry = Entry(add_supply_window, font=("Hanuman Regular", 16))
    product_price_entry.place(x=220, y=180, width=300)

    product_details_label = Label(add_supply_window, text="Product Details:", bg="#FFE1C6", font=("Hanuman Regular", 16))
    product_details_label.place(x=50, y=230)

    product_details_entry = Entry(add_supply_window, font=("Hanuman Regular", 16))
    product_details_entry.place(x=220, y=230, width=300)

    product_quantity_label = Label(add_supply_window, text="Product Quantity:", bg="#FFE1C6", font=("Hanuman Regular", 16))
    product_quantity_label.place(x=50, y=280)

    product_quantity_entry = Entry(add_supply_window, font=("Hanuman Regular", 16))
    product_quantity_entry.place(x=220, y=280, width=300)

    void_label = Label(add_supply_window, text="Is Void:", bg="#FFE1C6", font=("Hanuman Regular", 16))
    void_label.place(x=50, y=330)

    void_option = ttk.Combobox(add_supply_window, values=["No", "Yes"], font=("Hanuman Regular", 16), state="readonly")
...
def update_products_window():
    ...
    update_window.configure(bg="#FFE1C6")
    ...
    # Update Products label centered
    update_label = Label(
        update_window,
    ...
    update_label.place(relx=0.5, rely=0.05, anchor="n")

    # Similar entry fields and buttons as in Add Supply window
    # Adjust as needed based on the specific update functionality you want to provide
